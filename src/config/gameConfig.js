...
export const TRANSLATIONS = {
  fr: {
    ...
    tutorial: {
      ...
      prev: "Précédent",
      close: "Fermer",
      page1_title: "Objectif",
      page1_content: "Le but est d'accumuler le maximum d'argent !\nLancez des billes dans les zones payantes en bas du plateau.\nPlus la zone est au centre, plus elle rapporte.",
      page2_title: "Démarrage",
      page2_content: "Au début, une configuration aléatoire est tirée :\n• Multiplicateur : augmente vos gains finaux\n• Malus : ennemis, obstacles, etc.\nVous pouvez payer pour relancer si le tirage est trop difficile.",
      page3_title: "Gameplay",
      page3_content: "• Cliquez pour lancer une bille.\n• Visez pour faire un maximum de rebonds (Combos !).\n• Évitez que la bille ne sorte sur les côtés.",
      page4_title: "Dangers & Hardcore",
      page4_content: "• Attention aux Yokais (Pacman) : ils mangent vos billes ! (Mode Hardcore : Le curseur de tir est instable (taille, force, angle varient)).\n• C'est plus risqué mais plus gratifiant !",
    },
  },
  en: {
    menu: {
    ...
    tutorial: {
      ...
      prev: "Previous",
      close: "Close",
      page1_title: "Objective",
      page1_content: "The goal is to accumulate maximum money!\nLaunch balls into the paying zones at the bottom.\nThe center zones pay more.",
      page2_title: "Starting",
      page2_content: "At the start, a random configuration is drawn:\n• Multiplier: increases your final payout\n• Malus: enemies, obstacles, etc.\nYou can pay to reroll if the setup is too hard.",
      page3_title: "Gameplay",
      page3_content: "• Click to launch a ball.\n• Aim for maximum rebounds (Combos!).\n• Avoid dropping the ball off the sides.",
      page4_title: "Dangers & Hardcore",
      page4_content: "• Beware of Yokais (Pacman): they eat your balls! (Hardcore Mode: The launch cursor is unstable).\n• It's riskier but more rewarding!",
    },
  },
};
